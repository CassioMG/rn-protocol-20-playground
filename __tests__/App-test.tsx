...
it('Correctly parses data value', () => {
  /*****************************************************
    NOTE: the idea of this test is to test the SAME XDR
    parsing code that is being used on the React Native App.tsx
    component but on NODE env instead so we can investigate/compare
    why the XDR parsing always SUCCEEDS while in NODE env
    but FAILS while in React Native env (App.tsx) when
    the "js-xdr" package is on version "2.0.0" or above!
  ******************************************************/
